  ...
  return (
    <div className="rounded-lg border border-line bg-ink-2 p-4">
          ...
          p ? (
            <div
              ...
              style={{
                ...
                boxShadow: p.focus ? '0 0 14px color-mix(in srgb, var(--color-accent) 45%, transparent)' : undefined,
              }}
              title={p.name}
            >
      ...
      <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
        ...
        <p className="font-mono text-[10px] text-accent">t — my corner of it</p>
      </div>
    </div>
  )
}
